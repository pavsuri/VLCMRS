...
<div class="right-section-content">
    <div class="row">
       <!--
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 50px; margin-left: 30%; margin-bottom: 3%">
                <div class="form-group">
                    <label for="select-form" class="col-xs-12 col-sm-3 col-md-3 col-lg-1 control-label">Select Form</label>
                     <div class="col-xs-12 col-sm-8 col-md-7 col-lg-7">
                        <select  id="formId" data-style="btn-inverse" onchange="getFormList(this.value);"> 
                            <option>Select Form</option>
                            @foreach($data['formsData'] as $form)
                            <option value="{{{$form->id}}}" <?php //if($form->id == $data['formId']) { echo "selected=selected"; } ?>>{{{$form->name}}}</option>
                            @endforeach
                        </select>
                    </div>
                </div> 
  ...
  <input type="hidden" name="edit_form_id" value="1">
